...
`src/home/local/bin/<name>` and is meant to be exposed on the user's `$PATH`
...
Implementation: `src/home/local/bin/monitor`.
...
1. Place the file in `src/home/local/bin/<name>` (no extension, executable).
